        ...
        <fo:root>
            ...
            <fo:page-sequence master-reference="A4">
                ...
                <fo:flow flow-name="xsl-region-body">
                    <fo:wrapper font-family="ING Me" font-size="8pt" text-align="justify">
    ...
    <xsl:template match="processor">
        ...
        <xsl:if test="$plant-toc//entry[@name=$name]">
            ...
            <xsl:variable name="height"
                          ...
                          as="xs:decimal"/>
            <fo:inline text-align="center" display-align="center">
                <fo:instream-foreign-object height="{$height div 2.5}px" width="{$width div 2.5}px">
